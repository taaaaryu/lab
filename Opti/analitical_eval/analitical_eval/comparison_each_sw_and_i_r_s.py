    ...
    for h_add in h_adds:
        ...
        for num_software in softwares:
            ...
            for comb in all_combinations:
                ...
                if best_redundancy:
                    p_results.append((comb, best_redundancy, 1-max_system_avail))
            ...
            for redundancy in all_redundancies:
                ...
                if best_combination:
                    results.append((redundancy, best_combination, 1-max_system_avail))
                progress_tqdm.update(1)
            ...
            if len(results)>1 and len(placement_result)>1:
                ...
                if 4 <= num_software <= 7:
                    ax[0].plot(placement_sx, placement_sy, label=label1, color=cm.winter(num_software/n), linewidth=5)
                    ax[1].plot(redundancy_sx, redundancy_sy, label=label2, color=cm.autumn(num_software/n), linewidth=5)
                else:
        ...
        plt.savefig(f"comparison_each_sw_{n}_{h_add}_{H}.png")
